...
let todoInput = document.querySelector(".input");//class ka name as inut select kiya he 
let addTodoButton = document.querySelector(".button");// class name as button
...
function uuid() {//universal uniqe identification
...
showTodos.addEventListener("click", (e) => {
    let key = e.target.dataset.key;//e is event 
